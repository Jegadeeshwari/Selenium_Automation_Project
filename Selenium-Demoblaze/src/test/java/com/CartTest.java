...
public class CartTest extends Base {
	...
	public void addToCart() throws InterruptedException {
		...
		WebElement nexusPhone = driver.findElement(By.linkText("Nexus 6"));
		wait.until(ExpectedConditions.elementToBeClickable(nexusPhone));
		nexusPhone.click();

		WebElement firstPhone = driver.findElement(By.className("name"));
		System.out.println("First Added Phone: " + firstPhone.getText());

		WebElement nexusCart = driver.findElement(By.linkText("Add to cart"));
		wait.until(ExpectedConditions.elementToBeClickable(nexusCart));
		nexusCart.click();
